...
from TransitionModelGenerator import TransitionModelGeneratorFactory
...
class MarsRoverDisc(Env):
    ...
    def initialize(self):
        ...
        self.disc_actions = bidict(self.init_actions())
    ...
    def generate_tm(self):
        try:
            ...
            model = TransitionModelGeneratorFactory().generate(self, level=self.level, instance=self.instance)
